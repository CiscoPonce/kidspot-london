...
async function runMigration() {
  ...
  try {
    console.log('Running migration 023 (fixing insert_venue_if_not_duplicate function)...');
    const sqlPath = path.join(__dirname, 'db/migrations/023_fix_insert_venue_function.sql');
