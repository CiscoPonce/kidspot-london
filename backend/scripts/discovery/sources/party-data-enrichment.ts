    ...
    try {
      ...
      await db.query(
        `UPDATE venues SET
           ...
           byo_food_allowed   = COALESCE($7, byo_food_allowed),
           food_provided      = COALESCE($8, food_provided),
           kitchen_facilities = COALESCE($9, kitchen_facilities),
           party_source       = $10,
        ...
        [
          ...
          data.enquiryUrl,
          data.byoFoodAllowed ?? null,
          data.foodProvided ?? null,
          data.kitchenFacilities ?? null,
          data.source,
          venue.id,
        ],
      );
