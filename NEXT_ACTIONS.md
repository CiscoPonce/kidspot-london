...
1. **Phase 12-04: Borough CSV Pack** — Automate ingestion of high-value council datasets (parks, halls, libraries).
2. **Phase 12-05: OpenActive Pilot** — Add session-aware UX using activity feeds.
3. **Phase 12-06: Operator Integration** — Formal partnerships with leisure operators for clean data.
